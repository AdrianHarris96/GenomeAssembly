...
#Example: ./pre_fast.sh -f /home/groupb/bin/tools/fastqc-0.11.9-hdfd78af_1/bin/ -d /home/groupb/data -o /home/aharris334/preQC
...
do 
	...
	if [[ $extension == *"CGT"* ]]; then
		echo $FILE/$extension
		fast $FILE/$extension $FILE/$extension $extension 
	fi
done
